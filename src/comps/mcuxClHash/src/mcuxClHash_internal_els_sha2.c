...
MCUX_CSSL_FP_FUNCTION_DEF(mcuxClHash_els_oneShotSkeleton_sha2)
...
MCUX_CSSL_FP_FUNCTION_DEF(mcuxClHash_els_process_sha2)
...
MCUX_CSSL_FP_FUNCTION_DEF(mcuxClHash_els_finish_sha2)
