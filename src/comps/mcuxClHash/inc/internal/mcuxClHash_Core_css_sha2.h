...
/** @file  mcuxClHash_core_css_sha2.h
 *  @brief Internal definitions and declarations of the *CORE* layer dedicated to CSS
 */

#ifndef MCUXCLHASH_CORE_CSS_SHA2_H_
#define MCUXCLHASH_CORE_CSS_SHA2_H_
 ...
 *
 */
typedef MCUX_CSSL_FP_PROTECTED_TYPE(mcuxClHash_Status_t) (*mcuxClHash_css_AlgoCore_t)(
                        uint32_t options,
...
/**
 * @brief CSS hash processing
 *
 * This function calls mcuxClCss_Hash_Async to call CSS to process a input data. Note
 * it does not perform padding. This has to be done before calling the function.
 *
 * @param options   CSS options
 ...
 */
MCUX_CSSL_FP_FUNCTION_DECL(mcuxClHash_css_core_sha2)
...
#endif /* MCUXCLHASH_CORE_CSS_SHA2_H_ */
