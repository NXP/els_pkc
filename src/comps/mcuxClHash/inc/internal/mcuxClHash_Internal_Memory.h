...
#define MCUXCLHASH_INTERNAL_WACPU_SIZE_SHA2_224 (MCUXCLHASH_BLOCK_SIZE_SHA_224)      ///< CPU workarea consumption of SHA2-224
#define MCUXCLHASH_INTERNAL_WACPU_SIZE_SHA2_256 (MCUXCLHASH_BLOCK_SIZE_SHA_256)      ///< CPU workarea consumption of SHA2-256
#define MCUXCLHASH_INTERNAL_WACPU_SIZE_SHA2_384 (MCUXCLHASH_BLOCK_SIZE_SHA_384)     ///< CPU workarea consumption of SHA2-384
#define MCUXCLHASH_INTERNAL_WACPU_SIZE_SHA2_512 (MCUXCLHASH_BLOCK_SIZE_SHA_512)     ///< CPU workarea consumption of SHA2-512


#define MCUXCLHASH_MAX(a,b) ((a) > (b) ? (a) : (b))

#define MCUXCLHASH_INTERNAL_WACPU_MAX (MCUXCLHASH_MAX(MCUXCLHASH_INTERNAL_WACPU_SIZE_MD5, \
