...
/** @file  mcuxClHash_Memory.h
 *  @brief Defines the memory consumption for the mcuxClHash component */

#ifndef MCUXCLHASH_MEMORY_H_
#define MCUXCLHASH_MEMORY_H_
...
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_MD5          (1u)  ///< Defines the workarea size required for mcuxClHash_compare on MD5
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_SHA_1        (1u)  ///< Defines the workarea size required for mcuxClHash_compare on SHA-1
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_SHA2_224     (1u)  ///< Defines the workarea size required for mcuxClHash_compare on SHA2-224
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_SHA2_256     (1u)  ///< Defines the workarea size required for mcuxClHash_compare on SHA2-256
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_SHA2_384     (1u)  ///< Defines the workarea size required for mcuxClHash_compare on SHA2-384
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_SHA2_512     (1u)  ///< Defines the workarea size required for mcuxClHash_compare on SHA2-512
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_SHA2_512_224 (1u)  ///< Defines the workarea size required for mcuxClHash_compare on SHA2-512/224
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_SHA2_512_256 (1u)  ///< Defines the workarea size required for mcuxClHash_compare on SHA2-512/256
#define MCUXCLHASH_COMPARE_CPU_WA_BUFFER_SIZE_MAX          (1u)  ///< Defines the max workarea size required for mcuxClHash_compare
...
#define MCUXCLHASH_FINISH_CPU_WA_BUFFER_SIZE_SHA2_224     (64u)  ///< Defines the workarea size required for mcuxClHash_finish on SHA2-224
#define MCUXCLHASH_FINISH_CPU_WA_BUFFER_SIZE_SHA2_256     (64u)  ///< Defines the workarea size required for mcuxClHash_finish on SHA2-256
#define MCUXCLHASH_FINISH_CPU_WA_BUFFER_SIZE_SHA2_384     (128u)  ///< Defines the workarea size required for mcuxClHash_finish on SHA2-384
...
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_MD5          (1u)  ///< Defines the workarea size required for mcuxClHash_verify on MD5
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_SHA_1        (1u)  ///< Defines the workarea size required for mcuxClHash_verify on SHA-1
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_SHA2_224     (1u)  ///< Defines the workarea size required for mcuxClHash_verify on SHA2-224
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_SHA2_256     (1u)  ///< Defines the workarea size required for mcuxClHash_verify on SHA2-256
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_SHA2_384     (1u)  ///< Defines the workarea size required for mcuxClHash_verify on SHA2-384
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_SHA2_512     (1u)  ///< Defines the workarea size required for mcuxClHash_verify on SHA2-512
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_SHA2_512_224 (1u)  ///< Defines the workarea size required for mcuxClHash_verify on SHA2-512/224
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_SHA2_512_256 (1u)  ///< Defines the workarea size required for mcuxClHash_verify on SHA2-512/256
#define MCUXCLHASH_VERIFY_CPU_WA_BUFFER_SIZE_MAX          (1u)  ///< Defines the max workarea size required for mcuxClHash_verify

#define MCUX_CL_HASH_MAX_CPU_WA_BUFFER_SIZE               (1u)  ///< Defines the max workarea size required this component  
