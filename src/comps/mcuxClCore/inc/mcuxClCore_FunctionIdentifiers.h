...
#define MCUX_CSSL_FP_FUNCID_mcuxClRandomModes_TestMode_generateFunction_PTG3          (0x616Bu)
...
#define MCUX_CSSL_FP_FUNCID_mcuxClRandomModes_selftest_VerifyArrays                   (0x6279u)
