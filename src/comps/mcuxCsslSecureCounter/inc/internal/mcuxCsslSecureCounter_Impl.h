...
#  include <internal/mcuxCsslSecureCounter_Hybrid_LocalCDOG.h>
#elif defined(MCUX_CSSL_SC_USE_HW_S3SCM) && (1 == MCUX_CSSL_SC_USE_HW_S3SCM)
#  include <internal/mcuxCsslSecureCounter_HW_S3SCM.h>
...
#  include <internal/mcuxCsslSecureCounter_SW_Callback.h>
