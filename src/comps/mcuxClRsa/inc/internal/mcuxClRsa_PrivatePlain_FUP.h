...
#define mcuxClRsa_PrivatePlain_ReductionME_LEN  3u

extern const mcuxClPkc_FUPEntry_t mcuxClRsa_PrivatePlain_ReductionME[mcuxClRsa_PrivatePlain_ReductionME_LEN];
