...
/**
 * @file  mcuxClPsaDriver_keygen_export_public_key_brainpoolpr1_example.c
 * @brief Example for brainpool_p_r1 384bits curve key pairs generating and public exporting
 *
 * @example mcuxClPsaDriver_keygen_export_public_key_brainpoolpr1_example.c
 * @brief Example for brainpool_p_r1 384bits curve key pairs generating and public exporting
 */
...
bool mcuxClPsaDriver_keygen_export_public_key_brainpoolpr1_example(void)
{
    ...
    psa_key_attributes_t keygenAttr = {
      .private_core = {                                                               // Core attributes
        .private_type = PSA_KEY_TYPE_ECC_KEY_PAIR(PSA_ECC_FAMILY_BRAINPOOL_P_R1),     // Keypair family with curve BRAINPOOL_P_R1
        .private_bits = MCUXCLKEY_SIZE_384 * 8u,                                     // Key bits of BRAINPOOL_P_R1_384
    ...
    psa_key_attributes_t exportAttr = {
      .private_core = {                                                               // Core attributes
        .private_type = PSA_KEY_TYPE_ECC_KEY_PAIR(PSA_ECC_FAMILY_BRAINPOOL_P_R1),     // Keypair family with curve BRAINPOOL_P_R1
        .private_bits = MCUXCLKEY_SIZE_384 * 8u,                                     // Key bits of BRAINPOOL_P_R1
        .private_lifetime = LIFETIME_EXTERNAL,                                        // Volatile (RAM), S50 Temporary Storage for private key
        .private_id = 0U,                                                             // ID zero
        .private_policy = {
