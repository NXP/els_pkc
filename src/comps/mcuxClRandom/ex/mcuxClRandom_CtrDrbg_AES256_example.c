...
/**
 * @file  mcuxClRandom_CtrDrbg_AES256_example.c
 * @brief Example for the mcuxClRandom component
 *
 * @example mcuxClRandom_CtrDrbg_AES256_example.c
 * @brief   Example for the mcuxClRandom component
 */
...
bool mcuxClRandom_CtrDrbg_AES256_example(void)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    MCUX_CSSL_FP_FUNCTION_CALL_BEGIN(selftestresult, token, mcuxClRandom_selftest(
                                                  &session,
                                                  mcuxClRandom_Mode_CtrDrbg_AES256));
    ...
    uint32_t context[(MCUXCLRANDOM_CTR_DRBG_AES256_CONTEXT_SIZE+sizeof(uint32_t)-1)/sizeof(uint32_t)] = {0};
