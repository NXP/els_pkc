...
const uint32_t mcuxClRandomModes_TestVectors_Entropy_Aes128_PrDisabled[] =
{
...
const uint32_t mcuxClRandomModes_TestVectors_Entropy_Aes256_PrDisabled[] =
{
...
const uint32_t mcuxClRandomModes_TestVectors_Entropy_Reseed_Aes128_PrDisabled[] =
{
...
const uint32_t mcuxClRandomModes_TestVectors_Entropy_Reseed_Aes256_PrDisabled[] =
{
...
const uint32_t mcuxClRandomModes_TestVectors_Init_Aes128_Key_PrDisabled[] =
{
  0xef83fcb5u, 0x3cda1815u, 0xee9855b8u, 0x1e009597u
};
/* Key = b7b3a93ecfdf2f61c622ad3afb6bff818736a09c9391157e1902d10a79d0db12 */
const uint32_t mcuxClRandomModes_TestVectors_Init_Aes256_Key_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_Init_Aes128_V_PrDisabled[] = {
  0xf70cf958u, 0x224ff85au, 0x84db1415u, 0xd107c07eu
};
/* V   = 0e4fb6443cae46188617aad8bfe46e23 */
const uint32_t mcuxClRandomModes_TestVectors_Init_Aes256_V_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_Reseed_Aes128_Key_PrDisabled[] = {
  0xcc797a57u, 0xc3582251u, 0xf3fc55e2u, 0x1a0ccff4u,
};
/* Key = d230044c2594510d195ffe9923de8848bdbd19f24d0e7558b28e55b2d4de7841 */
const uint32_t mcuxClRandomModes_TestVectors_Reseed_Aes256_Key_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_Reseed_Aes128_V_PrDisabled[] = {
  0xfd991553u, 0x67336f61u, 0x8b929281u, 0x2bbb71f7u

};
/* V   = e18637ff12f514f37adc2013a40f38c1 */
const uint32_t mcuxClRandomModes_TestVectors_Reseed_Aes256_V_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_GenOne_Aes128_Key_PrDisabled[] = {
  0xb33f37acu, 0xb0973577u, 0x376fcbd6u, 0x9392b5e6u

};
/* Key = ec871bb7a4f2c45dccdd0e514a21628959aa21e9643934f619b2709b3e38697c */
const uint32_t mcuxClRandomModes_TestVectors_GenOne_Aes256_Key_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_GenOne_Aes128_V_PrDisabled[] = {
  0x15f19bcdu, 0xcb605cd3u, 0xacebf2f7u, 0x3bf5438eu
};
/* V   = d8bbe7bfc60bfb710f39acd1088c9f41 */
const uint32_t mcuxClRandomModes_TestVectors_GenOne_Aes256_V_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_GenTwo_Aes128_Key_PrDisabled[] = {
  0x94574c96u, 0xa94a106au, 0x13c2c33fu, 0x11bcb97bu
};
/* Key = e728308a0e92cbacb269d12246d8e2d24cf5fcc678aa09564132e4972c456eda */
const uint32_t mcuxClRandomModes_TestVectors_GenTwo_Aes256_Key_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_GenTwo_Aes128_V_PrDisabled[] = {
  0x8000589du, 0x7c00ac33u, 0x4b25ad9eu, 0xb6e28dfau
};
/* V   = c95f38da34ecb65ebf8b34c32bc215a5 */
const uint32_t mcuxClRandomModes_TestVectors_GenTwo_Aes256_V_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_RandomData_Aes128_PrDisabled[] = {
...
const uint32_t mcuxClRandomModes_TestVectors_RandomData_Aes256_PrDisabled[] = {
...
const mcuxClRandomModes_DrbgModeDescriptor_t mcuxClRandomModes_DrbgModeDescriptor_CtrDrbg_AES128_PrDisabled =
{
...
const mcuxClRandomModes_DrbgModeDescriptor_t mcuxClRandomModes_DrbgModeDescriptor_CtrDrbg_AES192_PrDisabled =
{
    .pDrbgAlgorithms = &mcuxClRandomModes_DrbgAlgorithmsDescriptor_CtrDrbg,
...
const mcuxClRandomModes_DrbgModeDescriptor_t mcuxClRandomModes_DrbgModeDescriptor_CtrDrbg_AES256_PrDisabled =
{
    .pDrbgAlgorithms = &mcuxClRandomModes_DrbgAlgorithmsDescriptor_CtrDrbg,
