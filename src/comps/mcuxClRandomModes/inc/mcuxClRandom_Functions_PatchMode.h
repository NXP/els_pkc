...
typedef mcuxClRandom_Status_t (* mcuxClRandom_CustomGenerateAlgorithm_t)(
...
mcuxClRandom_Status_t mcuxClRandom_createPatchMode(
  mcuxClRandom_Mode_t patchMode,
  mcuxClRandom_CustomGenerateAlgorithm_t customGenerateAlgorithm,
  mcuxClRandom_Context_t *pCustomCtx,
