...
/* Last byte is not used, because reseedsize is 55 bytes */
static const uint32_t entropyInputReseed[CEILING(MCUXCLRANDOMMODES_TESTMODE_CTR_DRBG_AES256_RESEED_ENTROPY_SIZE, sizeof(uint32_t))] =
{
