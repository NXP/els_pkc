...
{
    MCUXCLELS_SFR_WRITE(DMA_SRC0,     (uint32_t) pInput);
    MCUXCLELS_SFR_WRITE(DMA_SRC0_LEN, inputSize);
}
...
{
    MCUXCLELS_SFR_WRITE(DMA_SRC1, (uint32_t) pInput);
}
...
{
    MCUXCLELS_SFR_WRITE(DMA_SRC2,     (uint32_t) pInput);
    MCUXCLELS_SFR_WRITE(DMA_SRC2_LEN, inputSize);
}
...
{
    MCUXCLELS_SFR_WRITE(DMA_RES0,     (uint32_t) pOutput);
    MCUXCLELS_SFR_WRITE(DMA_RES0_LEN, outputSize);
}
...
{
    MCUXCLELS_SFR_WRITE(KIDX0, index);
}
...
{
    MCUXCLELS_SFR_WRITE(KIDX1, index);
}
...
{
    MCUXCLELS_SFR_WRITE(KIDX2, index);
}
...
{
    MCUXCLELS_SFR_WRITE(KPROPIN, properties);
}

/** Starts an ELS command. */
static inline void mcuxClEls_startCommand(uint32_t command, uint32_t cmdcfg0, uint32_t byteOrder)
{
    uint32_t ctrl = MCUXCLELS_SFR_FIELD_FORMAT(CTRL, ELS_CMD, command)
                    | MCUXCLELS_SFR_FIELD_FORMAT(CTRL, ELS_START, 1u)
                    | MCUXCLELS_SFR_FIELD_FORMAT(CTRL, ELS_EN, 1u)
                    | MCUXCLELS_SFR_FIELD_FORMAT(CTRL, BYTE_ORDER, byteOrder);

    MCUXCLELS_SFR_WRITE(CMDCFG0, cmdcfg0);
    MCUXCLELS_SFR_WRITE(CTRL,    ctrl);
}
...
{
    return (0u != MCUXCLELS_SFR_BITREAD(STATUS, ELS_BUSY) );
}
...
#define MCUXCLELS_SFR_STATUS_PPROT               ELS_PPROT
#define MCUXCLELS_SFR_STATUS_DRBG_ENT_LVL        ELS_DRBG_ENT_LVL
#define MCUXCLELS_SFR_STATUS_DTRNG_BUSY          ELS_DTRNG_BUSY
...
#define MCUXCLELS_GET_STATUS_FIELD(field) \
  mcuxClEls_getSfrField(MCUXCLELS_SFR_READ(STATUS), MCUXCLELS_SFR_FIELD_MASK(STATUS, field), MCUXCLELS_SFR_FIELD_SHIFT(STATUS, field))
...
#define MCUXCLELS_GET_CTRL_FIELD(field) \
  mcuxClEls_getSfrField(MCUXCLELS_SFR_READ(CTRL), MCUXCLELS_SFR_FIELD_MASK(CTRL, field), MCUXCLELS_SFR_FIELD_SHIFT(CTRL, field))
...
#define MCUXCLELS_SET_CTRL_FIELD(field, value) \
  mcuxClEls_setSfrField(&MCUXCLELS_SFR_READ(CTRL), (value), MCUXCLELS_SFR_FIELD_MASK(CTRL, field), MCUXCLELS_SFR_FIELD_SHIFT(CTRL, field))
...
#define MCUXCLELS_GET_CFG_FIELD(field) \
  mcuxClEls_getSfrField(MCUXCLELS_SFR_READ(CFG), MCUXCLELS_SFR_FIELD_MASK(CFG, field), MCUXCLELS_SFR_FIELD_SHIFT(CFG, field))
...
#define MCUXCLELS_SET_CFG_FIELD(field, value) \
  mcuxClEls_setSfrField(&MCUXCLELS_SFR_READ(CFG), (value), MCUXCLELS_SFR_FIELD_MASK(CFG, field), MCUXCLELS_SFR_FIELD_SHIFT(CFG, field))
...
#define MCUXCLELS_GET_ERROR_STATUS_FIELD(field) \
  mcuxClEls_getSfrField(MCUXCLELS_SFR_READ(ERR_STATUS), MCUXCLELS_SFR_FIELD_MASK(ERR_STATUS, field), MCUXCLELS_SFR_FIELD_SHIFT(ERR_STATUS, field))
...
#define MCUXCLELS_SET_CMDCRC_CTRL_FIELD(field, value) \
  mcuxClEls_setSfrField(&MCUXCLELS_SFR_READ(CMDCRC_CTRL), (value), MCUXCLELS_SFR_FIELD_MASK(CMDCRC_CTRL, field), MCUXCLELS_SFR_FIELD_SHIFT(CMDCRC_CTRL, field))
