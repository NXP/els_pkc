...
#define MCUXCLCSS_AEAD_ACPMOD_INIT    ((uint32_t) 0U) ///< Set #mcuxClCss_AeadOption_t.acpmod to this value for Init mode. For internal use
#define MCUXCLCSS_AEAD_ACPMOD_AADPROC ((uint32_t) 1U) ///< Set #mcuxClCss_AeadOption_t.acpmod to this value for Process Additional Authenticated Data mode. For internal use
#define MCUXCLCSS_AEAD_ACPMOD_MSGPROC ((uint32_t) 2U) ///< Set #mcuxClCss_AeadOption_t.acpmod to this value for Process Message mode. For internal use
#define MCUXCLCSS_AEAD_ACPMOD_FINAL   ((uint32_t) 3U) ///< Set #mcuxClCss_AeadOption_t.acpmod to this value for Finalize mode. For internal use

#ifndef MCUXCL_FEATURE_CSS_NO_INTERNAL_STATE_FLAGS
#define MCUXCLCSS_AEAD_STATE_OUT_ENABLE  ((uint32_t) 1U) ///< Set #mcuxClCss_AeadOption_t.acpsoe to this value to save the state to the context. For internal use
...
#define MCUXCLCSS_AEAD_TAG_SIZE       16U  ///< tag size: Tag generation supports only a 128 bit wide tag (16 bytes)
