...
#define MCUXCLCSS_HASH_VALUE_MODE_SHA_224  ((uint32_t) MCUXCLCSS_HASH_MODE_SHA_224 << 4)  ///< Set this option at #mcuxClCss_HashOption_t.word.value to use the hash algorithm SHA-224
#define MCUXCLCSS_HASH_VALUE_MODE_SHA_256  ((uint32_t) MCUXCLCSS_HASH_MODE_SHA_256 << 4)  ///< Set this option at #mcuxClCss_HashOption_t.word.value to use the hash algorithm SHA-256
#define MCUXCLCSS_HASH_VALUE_MODE_SHA_384  ((uint32_t) MCUXCLCSS_HASH_MODE_SHA_384 << 4)  ///< Set this option at #mcuxClCss_HashOption_t.word.value to use the hash algorithm SHA-384
#define MCUXCLCSS_HASH_VALUE_MODE_SHA_512  ((uint32_t) MCUXCLCSS_HASH_MODE_SHA_512 << 4)  ///< Set this option at #mcuxClCss_HashOption_t.word.value to use the hash algorithm SHA-512
