...
#define MCUXCLCSS_KEYPROPERTY_VALUE_KEY_SIZE_512         ((uint32_t) 3u<< 0u) ///< 512-bit key
...
#ifdef MCUXCL_FEATURE_CSS_PUK_INTERNAL
#define MCUXCLCSS_KEYPROPERTY_VALUE_PUK                  ((uint32_t) 1u<<11u) ///< Trusted Public Key
#define MCUXCLCSS_KEYPROPERTY_VALUE_TECDH                ((uint32_t) 1u<<12u) ///< Private key that can only be used in ECDH with Trusted Public Key
#endif /* MCUXCL_FEATURE_CSS_PUK_INTERNAL */
...
#ifdef MCUXCL_FEATURE_CSS_PUK_INTERNAL
#define MCUXCLCSS_KEYPROPERTY_KEY_SIZE_512               3U ///< This value of #mcuxClCss_KeyProp_t.ksize indicates a 512 bit key
#endif /* MCUXCL_FEATURE_CSS_PUK_INTERNAL */
...
#ifdef MCUXCL_FEATURE_CSS_PUK_INTERNAL
#define MCUXCLCSS_KEYPROPERTY_PUK_TRUE                   1U ///< This value of #mcuxClCss_KeyProp_t.upuk indicates that the slot is a Trusted Public Key
#define MCUXCLCSS_KEYPROPERTY_PUK_FALSE                  0U ///< This value of #mcuxClCss_KeyProp_t.upuk indicates that the slot is not a Trusted Public Key
#define MCUXCLCSS_KEYPROPERTY_TECDH_TRUE                 1U ///< This value of #mcuxClCss_KeyProp_t.utecdh indicates that the slot is a Private key that can only be used in ECDH with Trusted Public Key
#define MCUXCLCSS_KEYPROPERTY_TECDH_FALSE                0U ///< This value of #mcuxClCss_KeyProp_t.utecdh indicates that the slot is not a Private key that can only be used in ECDH with Trusted Public Key
#endif /* MCUXCL_FEATURE_CSS_PUK_INTERNAL */
...
#define MCUXCLCSS_STATUS_SW_LOCKING_FAILED   ((mcuxClCss_Status_t) 0xF0F00FE1U) ///< Unable to obtain CSS lock
#define MCUXCLCSS_STATUS_SW_STATUS_LOCKED    ((mcuxClCss_Status_t) 0xF0F00FE2U) ///< CSS status is locked
...
/**
 * @brief Deprecated type for CSS driver protected status codes
 */
typedef MCUX_CSSL_FP_PROTECTED_TYPE(mcuxClCss_Status_t) mcuxClCss_Status_Protected_t;

/**
 * @brief Type for CSS keystore indices
 */
typedef uint32_t mcuxClCss_KeyIndex_t;
