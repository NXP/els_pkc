...
#define MCUXCLECC_KEYGEN_WACPU_SIZE(byteLenN)  (92u + MCUXCLECC_ALIGN_SIZE_CPU(byteLenN + 8u))  ///< CPU workarea size (in bytes) for #mcuxClEcc_KeyGen.
#define MCUXCLECC_SIGN_WACPU_SIZE(byteLenN)    (92u + MCUXCLECC_ALIGN_SIZE_CPU(byteLenN + 8u))  ///< CPU workarea size (in bytes) for #mcuxClEcc_Sign.
#else /* ! MCUXCL_FEATURE_CSS_ACCESS_PKCRAM_WORKAROUND */
#define MCUXCLECC_KEYGEN_WACPU_SIZE(byteLenN)  92u  ///< CPU workarea size (in bytes) for #mcuxClEcc_KeyGen. Parameter byteLenN is just to keep the API consistent.
#define MCUXCLECC_SIGN_WACPU_SIZE(byteLenN)    92u  ///< CPU workarea size (in bytes) for #mcuxClEcc_Sign. Parameter byteLenN is just to keep the API consistent.
#endif /* MCUXCL_FEATURE_CSS_ACCESS_PKCRAM_WORKAROUND */
#define MCUXCLECC_VERIFY_WACPU_SIZE     100u  ///< CPU workarea size (in bytes) for #mcuxClEcc_Verify.
#define MCUXCLECC_POINTMULT_WACPU_SIZE  92u  ///< CPU workarea size (in bytes) for #mcuxClEcc_PointMult.
 ...
 * @{
 */
#define MCUXCLECC_MONT_DHKEYGENERATION_CURVE25519_WACPU_SIZE    120u  ///< CPU workarea size (in bytes) for #mcuxClEcc_Mont_DhKeyGeneration.
#define MCUXCLECC_MONT_DHKEYGENERATION_CURVE448_WACPU_SIZE      144u  ///< CPU workarea size (in bytes) for #mcuxClEcc_Mont_DhKeyGeneration.
 ...
 * @{
 */
#define MCUXCLECC_EDDSA_GENERATEKEYPAIR_ED25519_WACPU_SIZE    228u  ///< CPU workarea size (in bytes) for #mcuxClEcc_EdDSA_GenerateKeyPaireration.
