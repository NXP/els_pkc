...
/**
 * @file  mcuxClMacModes_cmac_oneshot_internal_key_example.c
...
bool mcuxClMacModes_cmac_oneshot_internal_key_example(void)
{
    /* Example input size. */
    ...
    mcuxClEls_KeyIndex_t         key_idx_cmack = 6u;
    mcuxClEls_KeyProp_t          key_properties;

    key_properties.word.value = 0u;
    key_properties.bits.ucmac = MCUXCLELS_KEYPROPERTY_CMAC_TRUE;
    ...
    //Initializes a key handle, Set key properties and Load key to ELS.
