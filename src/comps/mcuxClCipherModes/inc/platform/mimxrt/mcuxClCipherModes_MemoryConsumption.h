...
#define MCUXCLCIPHER_AES_CRYPT_CPU_WA_BUFFER_SIZE_IN_WORDS        MCUXCLCORE_NUM_OF_CPUWORDS_FLOOR(MCUXCLCIPHER_AES_CRYPT_CPU_WA_BUFFER_SIZE)
...
#define MCUXCLCIPHER_AES_INIT_CPU_WA_BUFFER_SIZE_IN_WORDS         MCUXCLCORE_NUM_OF_CPUWORDS_FLOOR(MCUXCLCIPHER_AES_INIT_CPU_WA_BUFFER_SIZE)
