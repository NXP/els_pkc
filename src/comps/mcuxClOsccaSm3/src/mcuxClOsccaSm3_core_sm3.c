...
MCUX_CSSL_FP_PROTECTED_TYPE(void) mcuxClOsccaSm3_Safo_Hash_PreLoad(uint32_t *workArea)
{
    ...
    uint32_t sgi_sm3_ctrl = MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_MODE, 1u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_LOW_LIM, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_HIGH_LIM, 15u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_COUNT_EN, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, HASH_RELOAD, 1u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_STOP, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, NO_AUTO_INIT, 1u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_EN, 1u);
    ...
    uint32_t sgi_ctrl = MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_MASK(SAFO_SGI_CTRL,START)
                      | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_CTRL, CRYPTO_OP, 7u)
                      | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_CTRL, DATOUT_RES, 0u);
    ...
    sgi_sm3_ctrl |= MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_STOP, 1u);
    MCUXCLOSCCASM3_SAFO_SGI_SFR_WRITE(SM3_CTRL, sgi_sm3_ctrl);
...
MCUX_CSSL_FP_PROTECTED_TYPE(void) mcuxClOsccaSm3_Safo_Hash_Norm(uint32_t *workArea, uint32_t *data)
{
    ...
    //NO_AUTO_INIT = 1'b0
    //SM3_EN = 1'b1
    uint32_t sgi_sm3_ctrl = MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_MODE, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_LOW_LIM, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_HIGH_LIM, 15u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_COUNT_EN, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_STOP, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, NO_AUTO_INIT, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_EN, 1u);
    MCUXCLOSCCASM3_SAFO_SGI_SFR_WRITE(SM3_CTRL, sgi_sm3_ctrl);
    ...
    sgi_ctrl |= MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_CTRL, DATOUT_RES, 2u);
    MCUXCLOSCCASM3_SAFO_SGI_SFR_WRITE(CTRL, sgi_ctrl);
...
MCUX_CSSL_FP_PROTECTED_TYPE(void) mcuxClOsccaSm3_Safo_Hash_Auto(uint32_t *workArea, uint32_t *data)
{
    ...
    uint32_t sgi_sm3_ctrl = MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_MODE, 1u)
                          ...
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_HIGH_LIM, 15u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_COUNT_EN, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, HASH_RELOAD, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_STOP, 0u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, NO_AUTO_INIT, 1u)
                          | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_SM3_CTRL, SM3_EN, 1u);
    MCUXCLOSCCASM3_SAFO_SGI_SFR_WRITE(SM3_CTRL, sgi_sm3_ctrl);
    ...
    sgi_ctrl = MCUXCLOSCCASM3_SAFO_SGI_SFR_READ(CTRL);
    sgi_ctrl |= MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_CTRL, DATOUT_RES, 2u)
              | MCUXCLOSCCASM3_SAFO_SGI_SFR_FIELD_FORMAT(SAFO_SGI_CTRL, START, 1u);
    MCUXCLOSCCASM3_SAFO_SGI_SFR_WRITE(CTRL, sgi_ctrl);
