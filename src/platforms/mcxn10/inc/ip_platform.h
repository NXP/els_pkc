...
#define CSS_Type S50_Type
#define CSS ELS

#define PKC PKC0

// Define base address of CSS
#define CSS_SFR_BASE            S50         ///< base of CSS SFRs
#define CSS_SFR_NAME(sfr)       sfr         ///< full name of SFR
#define CSS_SFR_PREFIX          S50_        ///< sfr field name prefix
...
#define NXPCLCSS_HW_VERSION_REVISION            0
#define NXPCLCSS_HW_VERSION_MINOR               4
#define NXPCLCSS_HW_VERSION_MAJOR               3
#define NXPCLCSS_HW_VERSION_FW_REVISION         0
#define NXPCLCSS_HW_VERSION_FW_MINOR            4
#define NXPCLCSS_HW_VERSION_FW_MAJOR            2


#ifdef NXPCL_FEATURE_CSSV2_LINK_BASE_ADDRESS
...
#define CSS_SFR_BASE           ((S50_Type *) ip_css_base)
#endif /* NXPCL_FEATURE_CSSV2_LINK_BASE_ADDRESS */
