...
bool mcuxClPsaDriver_cipher_decrypt(void)
{
    ...
    psa_key_attributes_t attributes = {
		.private_core = {								// Core attributes
			...
			.private_policy = {
				.private_usage = PSA_KEY_USAGE_DECRYPT, // Key may be used for decryption
				.private_alg = PSA_ALG_ECB_NO_PADDING, 	// Key may be used for ECB mode without padding only
