...
bool mcuxClPsaDriver_rsa_PKCS1V15_sign_verify_message_example(void)
{
  ...
  const psa_key_attributes_t sign_attributes = {
    .private_core = {                                                                                                               // Core attributes
      ...
      .private_policy = {
        .private_usage = PSA_KEY_USAGE_SIGN_MESSAGE,                                                                                // Key may be used to signing a message
        .private_alg = PSA_ALG_RSA_PKCS1V15_SIGN(PSA_ALG_SHA_256),                                                                  // RSA PKCS#1 v1.5 signature with hashing
