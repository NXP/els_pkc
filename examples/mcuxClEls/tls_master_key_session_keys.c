    ...
    void)
{
    ...
    {
        return false; // Expect that no error occurred, meaning that the mcuxClEls_EccKeyExchange_Async operation was started.
    }
    MCUX_CSSL_FP_FUNCTION_CALL_END();
    ...
    {
        return false; // Expect that no error occurred, meaning that the mcuxClEls_Prng_GetRandom operation was started.
    }
    MCUX_CSSL_FP_FUNCTION_CALL_END();
