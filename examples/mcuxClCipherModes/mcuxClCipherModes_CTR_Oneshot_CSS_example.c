...
static uint8_t const msg_plain[3u * MCUX_CL_AES_BLOCK_SIZE - 4u] = {
...
static uint8_t const msg_enc_expected[3u * MCUX_CL_AES_BLOCK_SIZE - 4u] = {
...
bool mcuxClCipherModes_CTR_Oneshot_CSS_example(void)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    uint8_t msg_enc[3u * MCUX_CL_AES_BLOCK_SIZE - 4u];
    ...
    if((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClCipher_crypt) != token_enc) || (MCUX_CL_CIPHER_STATUS_OK != result_enc))
    {
        return MCUX_CL_EXAMPLE_ERROR;
    }
    ...
    uint8_t msg_dec[3u * MCUX_CL_AES_BLOCK_SIZE - 4u];
    ...
    if((MCUX_CSSL_FP_FUNCTION_CALLED(mcuxClCipher_crypt) != token_dec) || (MCUX_CL_CIPHER_STATUS_OK != result_dec))
    {
        return MCUX_CL_EXAMPLE_ERROR;
    }
    MCUX_CSSL_FP_FUNCTION_CALL_END();
