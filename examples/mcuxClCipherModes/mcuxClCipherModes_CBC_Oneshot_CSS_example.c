...
static uint8_t const msg_plain[3u * MCUX_CL_AES_BLOCK_SIZE] = {
...
static uint8_t const msg_enc_expected[3u * MCUX_CL_AES_BLOCK_SIZE] = {
...
bool mcuxClCipherModes_CBC_Oneshot_CSS_example(void)
{
    /**************************************************************************/
    /* Preparation                                                            */
    /**************************************************************************/
    ...
    uint8_t msg_enc[3u * MCUX_CL_AES_BLOCK_SIZE];
    ...
    uint8_t msg_dec[3u * MCUX_CL_AES_BLOCK_SIZE];
