...
static uint8_t const aes128_expected_output[MCUXCLCSS_CIPHER_BLOCK_SIZE_AES] = {0x3AU, 0xD7U, 0x7BU, 0xB4U,
...
bool cipher_aes128_ecb_encrypt(
    void)
{
    ...
    cipher_options.bits.cphmde = MCUXCLCSS_CIPHERPARAM_ALGORITHM_AES_ECB;  // Configure the AES block cipher mode of operation to be the ECB (Electronic Codebook) mode.
