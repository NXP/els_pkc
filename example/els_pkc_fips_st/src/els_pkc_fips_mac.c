 ...
 ******************************************************************************/
/* HMAC variables */
static uint8_t s_KeyHmacSha224[50U]  = {0xD2U, 0x70U, 0x6FU, 0x0EU, 0x3EU, 0x78U, 0x0AU, 0xC5U, 0x27U, 0x7AU,
...
static uint8_t s_MsgHmacSha224[128U] = {
...
static uint8_t s_MacKatHmacSha224[28U] = {0x75U, 0x15U, 0x12U, 0x16U, 0x93U, 0xBBU, 0x0DU, 0x4BU, 0xE5U, 0x26U,
                                          0xF0U, 0x00U, 0x17U, 0x8AU, 0x12U, 0x1DU, 0x88U, 0xDBU, 0x8EU, 0x54U,
                                          0x4FU, 0xE2U, 0x2FU, 0x67U, 0x64U, 0x9CU, 0xCFU, 0xBAU};

static uint8_t s_KeyHmacSha256[64U] = {
...
static uint8_t s_MsgHmacSha256[64U] = {0xAAU, 0xAAU, 0xAAU, 0xAAU, 0xAAU, 0xAAU, 0xAAU,      0xAAU, 0xAAU, 0xAAU, 0xAAU,
...
static uint8_t s_MacKatHmacSha256[32U] = {0x97U, 0x48U, 0x04U, 0xD9U, 0x2CU, 0x07U, 0x1FU, 0x13U, 0xE6U, 0x53U, 0x68U,
...
static uint8_t s_KeyHmacSha384[50U] = {0xC3U, 0x64U, 0x6AU, 0xE2U, 0xD6U, 0x5CU, 0x7CU, 0x2AU, 0xB2U, 0xEDU,
...
static uint8_t s_MsgHmacSha384[128U] = {
...
static uint8_t s_MacKatHmacSha384[48U] = {
...
static uint8_t s_KeyHmacSha512[50U] = {0x09U, 0x57U, 0x05U, 0x7EU, 0xD8U, 0x4FU, 0x8DU, 0x6CU, 0xE6U, 0x00U,
...
static uint8_t s_MsgHmacSha512[128U] = {
...
static uint8_t s_MacKatHmacSha512[64U] = {
