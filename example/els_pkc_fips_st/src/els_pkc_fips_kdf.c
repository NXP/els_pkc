...
static uint8_t s_PlainKeyCkdfSp800108[32U] = {
...
static uint8_t s_DerivationDataCkdfSp800108[12U] = {
    0xC8U, 0xACU, 0x48U, 0x88U, 0xA6U, 0x1BU, 0x3DU, 0x9BU, 0x56U, 0xA9U, 0x75U, 0xE7U,
};

static uint8_t s_AesInputCkdfSp800108[16U] = {0x35U, 0xE6U, 0x2CU, 0x18U, 0x02U, 0xCAU, 0x06U, 0x5BU,
                                              0xCDU, 0x56U, 0x1EU, 0xBFU, 0x9BU, 0xF0U, 0x2DU, 0x00U};

static uint8_t s_DerivedKeyKATCkdfSp800108[32U] = {
