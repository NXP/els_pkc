...
#define MCUX_CSSL_FP_FUNCID_mcuxClAead_ModeEngineAesCcmEls                            (0x678Eu)
...
#define MCUX_CSSL_FP_FUNCID_mcuxClAeadModes_finish                                    (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClAeadModes_process                                   (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClAeadModes_init                                      (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClAeadModes_process_adata                             (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClMacModes_createGmacMode                             (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClEcc_WeierECC_GenerateKeyPair                        (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClKey_generate_keypair                                (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClRandomModes_NormalMode_generateFunction_PrEnabled   (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClRandomModes_NormalMode_generateFunction_PTG3        (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClRandomModes_NormalMode_selftestFunction_PrEnabled   (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClRandomModes_NormalMode_selftestFunction_PTG3        (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClEcc_BlindedScalarMult                               (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClEcc_EdDSA_BlindedScalarMult                         (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClEcc_WeierECC_PointDecFct_SEC                        (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClEcc_EdDSA_VerifySignature_S5xyStub                  (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClEcc_EdDSA_GenerateSignature_S5xyStub                (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClSignature_selftest                                  (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClCipher_selftest                                     (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClEcc_WeierECC_SetupEnvironment                       (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_GetVersionAndConfig                          (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_GetStatus                                    (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_SyncReset                                    (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_SetIntEnable                                 (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_GetIntEnable                                 (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_ClearIntStatus                               (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_SetIntStatus                                 (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_Lock                                         (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_IsLocked                                     (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_IsIndexLocked                                (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_StartEnable                                  (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_ContinueEnable                               (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_LockIndex                                    (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_ResetIndex                                   (0xFFFFu)
#define MCUX_CSSL_FP_FUNCID_mcuxClGlikey_EndOperation                                 (0xFFFFu)
