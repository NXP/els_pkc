 ...
 * @{
 */
#define MCUXCLELS_AEAD_ENCRYPT ((uint32_t) 0U) ///< Set #mcuxClEls_AeadOption_t.dcrpt to this value to encrypt data
#define MCUXCLELS_AEAD_DECRYPT ((uint32_t) 1U) ///< Set #mcuxClEls_AeadOption_t.dcrpt to this value to decrypt data

#define MCUXCLELS_AEAD_STATE_IN_DISABLE ((uint32_t) 0U) ///< Set #mcuxClEls_AeadOption_t.acpsie to this value to load the GCM state from ELS
#define MCUXCLELS_AEAD_STATE_IN_ENABLE  ((uint32_t) 1U) ///< Set #mcuxClEls_AeadOption_t.acpsie to this value to load the GCM state from the context

#define MCUXCLELS_AEAD_LASTINIT_TRUE ((uint32_t) 1U)  ///< Set #mcuxClEls_AeadOption_t.lastinit to this value if this is the last call to init
#define MCUXCLELS_AEAD_LASTINIT_FALSE ((uint32_t) 0U) ///< Set #mcuxClEls_AeadOption_t.lastinit to this value if this is not the last call to init

#define MCUXCLELS_AEAD_EXTERN_KEY ((uint32_t) 1U) ///< Set #mcuxClEls_AeadOption_t.extkey to this value to use an external key
#define MCUXCLELS_AEAD_INTERN_KEY ((uint32_t) 0U) ///< Set #mcuxClEls_AeadOption_t.extkey to this value to use a key from the ELS keystore

#define MCUXCLELS_AEAD_ACPMOD_INIT    ((uint32_t) 0U) ///< Set #mcuxClEls_AeadOption_t.acpmod to this value for Init mode. For internal use
#define MCUXCLELS_AEAD_ACPMOD_AADPROC ((uint32_t) 1U) ///< Set #mcuxClEls_AeadOption_t.acpmod to this value for Process Additional Authenticated Data mode. For internal use
#define MCUXCLELS_AEAD_ACPMOD_MSGPROC ((uint32_t) 2U) ///< Set #mcuxClEls_AeadOption_t.acpmod to this value for Process Message mode. For internal use
#define MCUXCLELS_AEAD_ACPMOD_FINAL   ((uint32_t) 3U) ///< Set #mcuxClEls_AeadOption_t.acpmod to this value for Finalize mode. For internal use

#ifndef MCUXCL_FEATURE_ELS_NO_INTERNAL_STATE_FLAGS
#define MCUXCLELS_AEAD_STATE_OUT_ENABLE  ((uint32_t) 1U) ///< Set #mcuxClEls_AeadOption_t.acpsoe to this value to save the state to the context. For internal use
